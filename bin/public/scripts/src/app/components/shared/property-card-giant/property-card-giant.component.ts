...
@Component({
  selector: 'property-card-giant',
  templateUrl: './property-card-giant.component.html',
  styleUrls: ['./property-card-giant.component.scss']
})
export class PropertyCardGiantComponent implements OnInit {

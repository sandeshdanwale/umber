...
import { OpaqueToken, Inject, Injectable, NgModule } from '@angular/core';
...
export var DatabaseBackend = new OpaqueToken('IndexedDBBackend');
export var IDB_SCHEMA = new OpaqueToken('IDB_SCHEMA');
...
export var Database = (function () {
    ...
    Database.prototype.insert = function (storeName, records, notify) {
        ...
        return _do.call(write$, function (payload) { return notify ? _this.changes.next({ type: DB_INSERT, payload: payload }) : ({}); });
    };

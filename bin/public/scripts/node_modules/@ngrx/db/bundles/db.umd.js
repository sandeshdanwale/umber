(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/Observable'), require('rxjs/Subject'), require('rxjs/operator/mergeMap'), require('rxjs/operator/do'), require('rxjs/observable/from'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define(['exports', 'rxjs/Observable', 'rxjs/Subject', 'rxjs/operator/mergeMap', 'rxjs/operator/do', 'rxjs/observable/from', '@angular/core'], factory) :
    (factory((global.ngrx = global.ngrx || {}, global.ngrx.db = global.ngrx.db || {}),global.Rx,global.Rx,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable,global.ng.core));
}(this, (function (exports,rxjs_Observable,rxjs_Subject,rxjs_operator_mergeMap,rxjs_operator_do,rxjs_observable_from,_angular_core) { 'use strict';
...
var DatabaseBackend = new _angular_core.OpaqueToken('IndexedDBBackend');
var IDB_SCHEMA = new _angular_core.OpaqueToken('IDB_SCHEMA');
...
var Database = (function () {
    ...
    Database.prototype.deleteDatabase = function (dbName) {
        var _this = this;
        return new rxjs_Observable.Observable(function (deletionObserver) {
    ...
    Database.prototype.insert = function (storeName, records, notify) {
        ...
        return rxjs_operator_do._do.call(write$, function (payload) { return notify ? _this.changes.next({ type: DB_INSERT, payload: payload }) : ({}); });
    };
    Database.prototype.get = function (storeName, key) {
        var _this = this;
        var open$ = this.open(this._schema.name);
        return rxjs_operator_mergeMap.mergeMap.call(open$, function (db) {
            return new rxjs_Observable.Observable(function (txnObserver) {
        ...
        return rxjs_operator_mergeMap.mergeMap.call(open$, function (db) {
            return new rxjs_Observable.Observable(function (txnObserver) {
                ...
                var makeRequest = function (record) {
                    return new rxjs_Observable.Observable(function (reqObserver) {
                        var req;
                ...
                var requestSubscriber = rxjs_operator_mergeMap.mergeMap.call(rxjs_observable_from.from(records), makeRequest)

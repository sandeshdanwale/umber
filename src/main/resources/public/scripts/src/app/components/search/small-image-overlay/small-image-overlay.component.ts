...
@Component({
  selector: 'small-image-overlay',
  templateUrl: './small-image-overlay.component.html',
  styleUrls: ['./small-image-overlay.component.scss']
})
export class SmallImageOverlayComponent implements OnInit {

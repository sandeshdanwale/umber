...
export var ResultContainerComponent = (function () {
    function ResultContainerComponent(propertyService, landmarkService, developerService, tagService, uiService) {
    ...
    ], ResultContainerComponent.prototype, "user", void 0);
    ResultContainerComponent = __decorate([
        ...
        __metadata('design:paramtypes', [PropertyService, LandmarkService, DeveloperService, TagService, UiService])

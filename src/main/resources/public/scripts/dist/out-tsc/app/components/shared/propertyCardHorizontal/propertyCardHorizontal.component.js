...
export var PropertyCardHorizontalComponent = (function () {
    function PropertyCardHorizontalComponent() {
    }
    PropertyCardHorizontalComponent.prototype.ngOnInit = function () {
        this.style = 'url(/assets/images/logo.jpg)';
    };
    PropertyCardHorizontalComponent.prototype.ngOnChanges = function () {
        this.style = 'url(/assets/images/logo.jpg)';
    };
    Object.defineProperty(PropertyCardHorizontalComponent.prototype, "displayProperty", {
        get: function () {
    ...
    PropertyCardHorizontalComponent.prototype.mapToCurrencyString = function (price) {
        var displayPrice = '';
    ...
    PropertyCardHorizontalComponent.prototype.getDisplayPrice = function () {
        var displayPrice = '';
    ...
    PropertyCardHorizontalComponent.prototype.getDisplayPropertyName = function () {
        return this.property ? this.property.name : '';
    };
    PropertyCardHorizontalComponent.prototype.getDisplayDeveloperName = function () {
        return this.property ? this.property.developerName : '';
    };
    PropertyCardHorizontalComponent.prototype.getDisplayConfigs = function () {
        var is1BHK = false;
        var is2BHK = false;
        var is3BHK = false;
    ...
    PropertyCardHorizontalComponent.prototype.getDisplayAddress = function () {
        ...
        if (address) {
            ...
            var txt = lines + ', ' + this.property.cityName + ', ' + address.state;
    ...
    ], PropertyCardHorizontalComponent.prototype, "property", void 0);
    PropertyCardHorizontalComponent = __decorate([
        Component({
    ...
    return PropertyCardHorizontalComponent;
}());
//# sourceMappingURL=/Users/advayabha/devenv/repo/smart2/umber/src/main/resources/public/scripts/src/app/components/shared/propertyCardHorizontal/propertyCardHorizontal.component.js.map
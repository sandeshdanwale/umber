...
export var LandmarkListComponent = (function () {
    function LandmarkListComponent(uiService, tagService) {
    ...
    LandmarkListComponent.prototype.updateLandmarkDetailPanel = function (event, landmark) {
        if (event) {
    ...
    LandmarkListComponent.prototype.addTag = function (event, landmark) {
        if (event) {
            event.stopPropagation();
            event.preventDefault();
        }
    ...
    __decorate([
        Input(), 
        __metadata('design:type', Array)
    ], LandmarkListComponent.prototype, "tags", void 0);
